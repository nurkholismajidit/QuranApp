...
//       setAyahs(data.data.verses); // Menyesuaikan dengan response API
//     } catch (err) {
...
//     <TouchableOpacity style={styles.ayahItem} onPress={() => fetchSpecificAyah(selectedSurah!.number, item.number)}>
//       {/* Safeguard Arabic text rendering */}
//       <Text style={styles.ayahText}>
//         {item.text?.arab || 'No Arabic text available'}
//       </Text>
  
//       {/* Safeguard English translation rendering */}
//       <Text style={styles.ayahTranslation}>
//         {item.translation?.id || 'No translation available'}
//       </Text>
//     </TouchableOpacity>
//   );
